                  ...
                  return (
                    <div key={phase.phase_number} className="border rounded-lg p-5 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="mt-3 grid grid-cols-3 gap-4 text-sm">
                        <div>
                          <span className="text-gray-500 dark:text-gray-400">未完了:</span>
                          <span className="ml-2 font-medium text-gray-900 dark:text-gray-100">{phaseTotalTasks - phaseCompletedTasks}</span>
                        </div>
                        <div>
                          <span className="text-gray-500 dark:text-gray-400">進行中:</span>
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                            ...
                                            {isImage ? (
                                              <img
                                                ...
                                                onError={(e) => {
                                                  ...
                                                  e.target.parentElement.innerHTML = '<svg class="w-6 h-6 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>';
                                                }}
                                              />
                                            ) : isPdf ? (
                              ...
                              {/* Notes */}
                              {item.notes && (
                                <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 rounded p-2">
                                  📝 {item.notes}
                                </div>
                              )}
                            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6" data-testid="ai-tab">
            ...
            {aiResponse && (
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4" data-testid="ai-response">
                <div className="mb-3">
                  <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">あなた:</div>
